...
public class Activity_Three_Paran {
  ...
  public static void main(String[] args) {
   Scanner sc = new Scanner(System.in);
    ...
    System.out.print("Number C1 Meal: ");
    int numberOfC1 = sc.nextInt();
    
    System.out.print("Number of C2 Meal: ");
    int numberOfC2 = sc.nextInt();
    
    System.out.print("Number of C3 Meal: ");
    int numberOfC3 = sc.nextInt();
    
    System.out.print("Number of C4 Meal: ");
    int numberOfC4 = sc.nextInt();
    
    System.out.print("Number of C5 Meal: ");
    ...
    System.out.println("Total C1 Price: "+c1TotalPrice);
    System.out.println("Total C2 Price: "+c2TotalPrice);
    System.out.println("Total C3 Price: "+c3TotalPrice);
    System.out.println("Total C4 Price: "+c4TotalPrice);
    System.out.println("Total C5 Price: "+c5TotalPrice+"\n");
    ...
    System.out.println("Total R1 Price: "+r1TotalPrice);
    System.out.println("Total R2 Price: "+r2TotalPrice+"\n");
